...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Keel agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-keel starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-keel" / "runs")
    return Keel(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-keel> ").strip()
