...
from keel.evaluation.metrics import collect_project_metrics, render_project_metrics_markdown  # noqa: E402


def build_arg_parser():
    parser = argparse.ArgumentParser(description="Collect keel project metrics from benchmark and run artifacts.")
...
def main(argv=None):
    ...
    output_md.write_text(render_project_metrics_markdown(metrics) + "\n", encoding="utf-8")
    return 0
