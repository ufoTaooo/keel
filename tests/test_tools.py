...
from keel.tool_context import ToolContext
from keel.tools import build_tool_registry, tool_delegate, tool_read_file


def test_tool_context_supports_file_tools_without_full_keel(tmp_path):
